...
namespace Valsom.AnsiBuilder.Test
{
    public class Build
    {
        ...
        public void BuildsWithoutColor()
        {
            ...
            Assert.Equal("Hello world!", builder.Build());
        }
        ...
        public void BuildsWithColor()
        {
            ...
            Assert.Equal("\u001b[38;2;255;0;0mI \u001b[48;2;0;128;0mam \u001b[7mtesting", builder.Build());
        }
        ...
        public void BuildsWithSpecials()
        {
            ...
            Assert.Equal("\u001b[1mIs \u001b[3mthis \u001b[4mworking?", builder.Build());
        }
    }
}